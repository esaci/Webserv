...
// 7 (ne sais pas) ◦ Définir une redirection HTTP.
...
class P_server
{
    ...
    public:
        ...
        _MAP_REDIRECT   map_redirect;   // context: server location;
